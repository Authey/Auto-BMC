...
static Std_ReturnType IoHwAb_Digital_Write_FrontLight(IoHwAb_LevelType newValue)
{
...
/* @req ARCIOHWAB011 */
static Std_ReturnType IoHwAb_Digital_Read_FrontDoorLeft(IoHwAb_LevelType *value, IoHwAb_StatusType *status)
{
...
/* @req ARCIOHWAB011 */
static Std_ReturnType IoHwAb_Digital_Read_FrontDoorRight(IoHwAb_LevelType *value, IoHwAb_StatusType *status)
{
	IOHWAB_VALIDATE_RETURN((NULL != value), IOHWAB_DIGITAL_READ_ID, IOHWAB_E_PARAM_PTR, E_NOT_OK);
	IOHWAB_VALIDATE_RETURN((NULL != status), IOHWAB_DIGITAL_READ_ID, IOHWAB_E_PARAM_PTR, E_NOT_OK);
...
/* @req ARCIOHWAB011 */
static Std_ReturnType IoHwAb_Digital_Read_FrontLight(IoHwAb_LevelType *value, IoHwAb_StatusType *status)
{
	IOHWAB_VALIDATE_RETURN((NULL != value), IOHWAB_DIGITAL_READ_ID, IOHWAB_E_PARAM_PTR, E_NOT_OK);
	IOHWAB_VALIDATE_RETURN((NULL != status), IOHWAB_DIGITAL_READ_ID, IOHWAB_E_PARAM_PTR, E_NOT_OK);
